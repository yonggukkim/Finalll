			...
			<div class="row">
				<div class="col-lg-8 mx-auto">
					<table class="table table-bordered">
						...
						<tbody>
							<form:form commandName="notice" action="notice_insert"
								method="post" encType="multiplart/form-data">
								<form:hidden path="noticeNum" />
								<form:hidden path="staffNumber" value="4" />
								<form:hidden path="noticeCount" value="4" />
								<tr>
									<th>제목 :</th>
									<td><form:input path="noticeSubject" /></td>
								</tr>
								<tr>
									<th>내용 :</th>
								...
								<tr>
									<td colspan="2"><input type="submit" value="등록" /><a
										href="notice_list"> <input type="button" value="글 목록"></a></td>
								</tr>
							</form:form>
					</table>
				</div>
