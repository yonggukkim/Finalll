		...
		<div class="row">
			...
			<div class="col-lg-3">
				...
				<div class="list-group">
					<a href="#" class="list-group-item active">이전 상품 목록</a> <a href="#"
			...
			<div class="col-lg-9">
				...
				<div class="card mt-4">
					<div id="carouselExampleIndicators"
						class="carousel slide card-img-top img-fluid" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img class="d-block w-100" src="/finalProject/img/pkg1.jpg"
									alt="First slide">
							</div>
							<div class="carousel-item">
								<img class="d-block w-100" src="/finalProject/img/pkg2.jpg"
									alt="Second slide">
							</div>
							<div class="carousel-item">
								<img class="d-block w-100" src="/finalProject/img/pkg3.jpg"
									alt="Third slide">
							</div>
						</div>
				...
				<div class="card card-outline-secondary my-4">
					...
					<div class="card-body card card-outline-secondary">
						...
						<small class="text-muted">Posted by Anonymous on 3/1/17</small>
						<hr>
						<a href="#" class="btn">상품 추가</a> <a href="#" calss="btn">뒤로
							가기</a>
					</div>
				</div>
				<!-- /.card -->
