<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="model.SelfPlanNumber"%>
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%>
<%
	request.setCharacterEncoding("utf-8");
	SelfPlanNumber selfPlanNumber = (SelfPlanNumber) request.getAttribute("selfPlanNumber");
%>
<!DOCTYPE html>
<html lang="en">
...
<title>selfPlan_delete.jsp</title>
			...
			<div class="row">
				<div class="col-lg-8 mx-auto">
					<table class="table table-bordered">
						...
						<tbody>
							<form:form commandName="selfPlanNumber"
								action="selfPlanNumber_delete" method="post"
								encType="multiplart/form-data">
								<form:hidden path="selfPlanNumber"
									value="<%=selfPlanNumber.getSelfPlanNumber()%>" />
								<tr>
									<th>비밀번호 :</th>
								...
								<tr>
									<td colspan="2"><input type="submit" value="삭제" /> <a
										href="selfPlanNumber_list"> <input type="button"
											value="글 목록" /></a></td>
								</tr>
							</form:form>
					</table>
