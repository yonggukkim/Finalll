...
<title>selfPlan_detail.jsp</title>
					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td rowspan="5" colspan="5">내용d입니다</td>
							</tr>
						</tbody>
						<tfoot>
							<tr>
							...
							<tr>
								<td colspan="5" scope="row"><a
									...
									href="selfPlan_delete?selfPlanNumber=<%=selfPlanNumber.getSelfPlanNumber()%>">
										<input type="button" value="글 삭제" />
								</a><a href="selfPlan_list"><input type="button" value="글 목록" /></a></td>
							</tr>
						</tfoot>
					</table>
				</div>
